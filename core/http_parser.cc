...
namespace No
{
    namespace HTTP {
        ...
        int HTTPParser::parse(const char* data, int len) {
        ...
        llhttp_settings_t HTTPParser::settings = {
            ...
            [](llhttp_t * parser, const char * data, size_t len) {
                return ((HTTPParser *)parser->data)->on_url(parser, data, len);
            },
            [](llhttp_t * parser, const char * data, size_t len) {
                return ((HTTPParser *)parser->data)->on_status(parser, data, len);
            },
            nullptr,
            nullptr,
            [](llhttp_t * parser, const char * data, size_t len) {
                return ((HTTPParser *)parser->data)->on_header_field(parser, data, len);
            },
            [](llhttp_t * parser, const char * data, size_t len) {
                return ((HTTPParser *)parser->data)->on_header_value(parser, data, len);
            },
            nullptr,
            nullptr,
            [](llhttp_t * parser) {
            ...
            [](llhttp_t * parser, const char * data, size_t len) {
                return ((HTTPParser *)parser->data)->on_body(parser, data, len);
            },
            [](llhttp_t * parser) {
